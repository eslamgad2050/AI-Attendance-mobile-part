...
//        getSupportActionBar().hide();
    ...
    void get_location() {
        ...
        fusedLocationClient.getCurrentLocation(Priority.PRIORITY_BALANCED_POWER_ACCURACY, null).addOnSuccessListener(this, new OnSuccessListener<Location>() {
            @Override
            public void onSuccess(Location l) {
                ...
                if (location != null) {
                    ...
                    location = l;
                    Toast.makeText(MainActivity2.this, "location long: " + location.getLongitude() + "\nlt: " + location.getLatitude(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
